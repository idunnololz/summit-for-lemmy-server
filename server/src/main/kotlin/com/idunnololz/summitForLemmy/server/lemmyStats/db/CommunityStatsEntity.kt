...
open class StringIdTable(name: String = "", idColumnName: String = "id", idColumnSize: Int = 32) : IdTable<String>(
  name,
) {
...
abstract class StringEntityClass<E : StringEntity>(table: IdTable<String>) : EntityClass<String, E> (
  table,
)
